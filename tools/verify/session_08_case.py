...
PROMISED = ["table", "train", "test", "columns", "one_model", "majority", "line",
            "raw_model", "free_model", "one_pipe", "p_one", "auc_one", "acc_one", "cm",
            "by_threshold", "auc_folds", "search", "auc_wide", "kept", "desk", "beats",
            "buckets", "report"]
