...
# -*- coding: utf-8 -*-
"""Run every folded solution of the Session 8 exercises against the real data.

The setup cell runs once. The exercises build on each other (E3 uses the masks
E2 built, J2 uses the `build_table` J1 wrote), so every solution runs
