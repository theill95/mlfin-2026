...
# -*- coding: utf-8 -*-
"""Run every folded solution of the Session 6 exercises against the real data.

The setup cell runs once. The exercises build on each other (A3 adds to the
`own` that A2 made, K1 uses the `build_table` A7 wrote), so every solution runs
