...
# -*- coding: utf-8 -*-
"""Run every {pyodide} cell of the Session 5 deck, in document order, in ONE
...
# The three "Your turn" cells ship with `...` blanks, so they are meant to
# fail until a student fills them in. Everything else must run clean.
