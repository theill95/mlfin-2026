...
# -*- coding: utf-8 -*-
"""Cumulative check for the Session 8 case: run the quick load, then exec every
...
os.chdir(str(Path(__file__).resolve().parents[2] / "session_09"))
import matplotlib
matplotlib.use("Agg")

NB = "session_09_case.ipynb"
...
PROMISED = ["table", "columns", "train", "test", "majority", "jump_model", "p_jump",
            "acc_jump", "auc_jump", "ap_jump", "called", "chosen", "called_chosen",
            "weighted", "pred_w", "by_bucket", "fixed", "p_fixed", "search", "auc_wide",
            "three", "pred_move", "knn_search", "logistic_folds", "desk_share",
            "desk_auc", "silent", "report", "summarise"]
